    ...
    actions: {
        ...
        return this.$axios
          ...
          .then(result => {
            ...
            localStorage.setItem(
              'tokenExpiration',
              new Date() + result.expiresIn * 1000
            )
            Cookie.set('jwt', result.idToken)
            Cookie.set('expirationDate', new Date() + result.expiresIn * 1000)
      ...
      initAuth(vuexContext, req) {
        ...
        if (req) {
          ...
          const jwtCookie = req.headers.ookie
            .split(';')
          ...
          expirationDate = req.headers.ookie
            .split(';')
